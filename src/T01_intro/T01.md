...
![bg contain right:40%](img/paste-1752391333342.png)
...
- What is $V$?
  ![bg contain right:40%](img/paste-1752391635553.png)
...
$$
\begin{eqnarray}
V(S_0) &=& 0.1 Q(a_1) + 0.8 Q(a_2) + 0.1 Q(a_3) \\
...
![alt text](img/paste-1752392067622.png)
...
- If fact, in most cases you will find that most environment that can be modelled by a MDP has an optimal policy which is deterministic.
